  ...
  en: {
    ...
    main: {
      ...
      balance: {
        ...
        twaProgressHint: '{current} of {total} views · +{reward} TWA per view',
        ...
        dailyQuota: 'Today: {current}/{max} views (5×12, 30 min break)',
  ...
  ru: {
    ...
    main: {
      ...
      balance: {
        ...
        twaProgressHint: '{current} из {total} просмотров · +{reward} TWA за просмотр',
        ...
        dailyQuota: 'Сегодня: {current}/{max} просмотров (5×12, пауза 30 мин)',
  ...
  uk: {
    ...
    main: {
      ...
      balance: {
        ...
        twaProgressHint: '{current} з {total} переглядів · +{reward} TWA за перегляд',
        twaBalanceLabel: 'Баланс TWA',
        batchProgress: 'Блок {batch} з {totalBatches}: залишилось {left} переглядів',
        batchCooldown: 'Перерва між блоками: ~{minutes} хв',
        dailyQuota: 'Сьогодні: {current}/{max} переглядів (5×12, пауза 30 хв)',
